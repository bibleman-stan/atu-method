...
1. **[[1-method/framework.md|framework.md §2.3]] DOES NOT EXIST.** Live framework §2 ends at §2.2 (line 117); next heading is §3 at line 118. Any "use §2.3" proposal is non-executable. ([[1-method/framework.md|framework.md]] heading grep: only §2.1 + §2.2 under §2.)
...
| anchor | type | authoritative home | status | live-successor | ALL consumers (file:line) | proposed_disposition | rationale |
|---|---|---|---|---|---|---|---|
| **§1.1** Generative principle (each proposition splits by default; bidirectional atomic-thought test) | section | `_old/framework.md:47-65` | superseded→[[1-method/cross-corpus-principles.md#§1.1 Generative principle — candidate-ATU substrate|cross-corpus-principles.md §1.1]] | [[1-method/cross-corpus-principles.md#§1.1 Generative principle — candidate-ATU substrate|cross-corpus-principles.md §1.1]] (reconciled-restore: candidate-ATU substrate + live KEEP-AS-IS default + R27/M-series merge-direction + R6/R7/R20/R21 split-license-identification) | 2-evidence/scholarship/bofm/R20.md:126, R21.md:21,130, R27.md:105,172, R6.md:17,30, R7.md:17,81, R5.md:147; atu-method/memories/feedback_atu_test_is_bidirectional.md, feedback_grammar_constrains_not_determines.md, feedback_rhetoric_figures_constrain_atu.md; BoFM canon:34 + GNT canon:48 pointer blocks; readers-gnt/scripts/audit_anaphoric_gen_abs_macula.py:6 | **supersede→[[1-method/cross-corpus-principles.md#§1.1 Generative principle — candidate-ATU substrate|cross-corpus-principles.md §1.1]]** (Stan 2026-06-06: option (a)) | Restored as candidate-ATU substrate statement, not as "split-by-default" doctrine. Live KEEP-AS-IS default is upheld; the principle re-frames what R6/R7/R20/R21 (license-identifiers) and R27/M-series (merge-direction-on-candidate-pair) operate on. |
...
| anchor | type | authoritative home | status | live-successor | ALL consumers (file:line) | proposed_disposition | rationale |
|---|---|---|---|---|---|---|---|
| [[1-method/framework.md|framework.md]] | doc | itself | live | n/a | universal — every per-corpus canon + scholarship + memories + reader CLAUDE.md | n/a | The atu-method canonical methodology spec. |
| `_old/framework.md` | doc | itself | archived | [[1-method/framework.md|framework.md]] (post-2026-05-18 rewrite) | `_old/` directory + per-concept dispositions above | n/a | Archived 2026-05-18 mechanical-first rewrite. Sole source for §0.x / §1.x bodies until migration completes. |
| `_old/change-protocol.md` | doc | itself | archived | [[1-method/framework.md#§7 Change discipline|framework.md §7]] (Stage 1 extracted 2026-06-05, commit 93d67f5) | resolved by Stage 1 | n/a | Stage 1 §7.x migration sourced from this archived doc. |
| [[1-method/binding-rules-hebrew.md|binding-rules-hebrew.md]] | doc | itself | live | n/a | 28 occurrences across 15 files (proof-of-concept that companion docs survive when indexed) | n/a | Sister catalog precedent for the proposed `structural-licenses.md`. |
| [[1-method/binding-rules-lxx.md|binding-rules-lxx.md]] | doc | itself | **PARKED** (committed 2026-06-06, commit ba04629; smoke-test artifact per Track A4) | n/a | 00-start-here.md:28 (Track A4 fix) | n/a | Smoke-test artifact, pipeline parked 2026-05-27 per banner. |
...
| [[1-method/glossary.md|glossary.md]] | doc | itself | live (stale per forensic audit) | n/a | framework.md, apparatus.md, architecture.md, _index.md | needs `§7.0 Categories A/B/C` reference update (claudit findings 2026-06-05) | Out of §-renumber scope for this halt; flagged for next-cycle. |
| [[4-process/methodology-position.md|methodology-position.md]] | doc | itself | live | n/a | framework.md L249, apparatus.md, toolset-architecture.md, _index.md | adjacent to §0.3 disposition but NOT the §0.3 host | LDHB / discourse-grammar relationship; not the pragmatic-stance host. |

### Part C-bis — `framework.md §7.x` Change-discipline family (post-Stage 1)

All §7.x sections are LIVE in [[1-method/framework.md|framework.md]] post-Stage 1 (commit 93d67f5, 2026-06-05). Sourced
...
| anchor | type | authoritative home | status | live-successor | ALL consumers (file:line) | proposed_disposition | rationale |
|---|---|---|---|---|---|---|---|
| **§7.0** Categories A / B / C | section | `framework.md:237-256` | **live** | n/a (this IS the live anchor) | Repointed from old [[1-method/framework.md#§2 The criterion — what licenses a standalone ATU|framework.md §2]] in Stage 1; consumers include 2-evidence/scholarship/bofm/EP-1.md:153 (after Batch A1 edit "§2 (Category B editorial-judgment)" → "§7.0 (Category B editorial-judgment)"); 4 EP-rules + multiple R-rules reference Category A/B/C semantics | n/a | Stage 1 (commit 93d67f5) extracted from `_old/framework.md:343-361` per Amendment 1 to resolve dangling "Category A/B/C" cross-refs in §7.3 #4 / §7.4 first bullet / §7.8 #3. |
...
| **§7.9** Binding-rule design checklist (per-rule additions) | section | `framework.md:352-362` | **live** | n/a | (no direct cites; preserves prior live [[1-method/framework.md#§7 Change discipline|framework.md §7]] 4-step checklist — BHSA features / validated chapter set / cold-eye-match / binding-rules-hebrew.md discipline) | n/a | Stage 1 PRESERVED — not extracted from archive; was the prior live [[1-method/framework.md#§7 Change discipline|framework.md §7]] 10-line section before Stage 1's §7.x expansion. Kept so the binding-rule-specific discipline is not lost in the §7.x migration. |

### Part D — Concept-level rows (named concepts without §-id)

| anchor | type | authoritative home | status | live-successor | ALL consumers (file:line) | proposed_disposition | rationale |
|---|---|---|---|---|---|---|---|
| **ATU vs. rhetorical/discourse lens distinction** | concept (methodology principle) | `atu-method/memories/feedback_atu_and_rhetorical_lenses_distinct.md` (NEW 2026-06-06) | live | n/a | [[1-method/cross-corpus-principles.md#§0.1 Lens scope — ATU vs. rhetorical/discourse structure|cross-corpus-principles.md §0.1]] (lens scope); anchor-paper future use; per-verse audits when rhetorical instinct ≠ ATU disposition (Alma 34:16 anchor case) | **live — co-shipped with B1** | Stan's articulation 2026-06-06: ATU and rhetorical/discourse lenses are different criteria on the same text; naming the distinction is itself a methodology contribution. Memory captures the principle + how-to-apply + Alma 34:16 anchor + future-paper framing against Chafe/Korpel-Oesch/Cresti/Hannay-Kroon/discourse-grammar precedent. Cross-corpus-principles.md §0.1 (lens scope) is the canonical-companion brief surface; the memory is the full statement. |
...
| § | Ruling | Disposition |
|---|---|---|
| §1.1 generative principle | (a) supersede with reconciliation | New [[1-method/cross-corpus-principles.md#§1.1 Generative principle — candidate-ATU substrate|cross-corpus-principles.md §1.1]]. Candidate-ATU substrate is restored; live KEEP-AS-IS default upheld. |
...
| [[1-method/cross-corpus-principles.md|cross-corpus-principles.md]] creation | YES | Doc to be created (B1); index entry + Tanakh canon:11-16 row mitigate born-orphan. |
...
|---|---|---|---|
| **B1** | Author [[1-method/cross-corpus-principles.md|cross-corpus-principles.md]] + add [[00-start-here.md]] entry + add Tanakh canon:11-16 row | §7.3 trigger #1 (new canon doc) — adversarial audit required | YES — review doc content + §1.1 reconciliation paragraph before commit |

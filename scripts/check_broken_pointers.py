#!/usr/bin/env python3
# PROVENANCE: recovered 2026-08-06 from Claude Code file-history (b15d8d3f-13d4-4a90-bd66-6ad57e8b4350/f3b1940b03ed6ed6@v3); state as of 2026-05-22; possibly stale — re-verify before relying.
"""

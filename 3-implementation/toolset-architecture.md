...
This document specifies the pipeline implementation. The framework spec ([`framework.md` §3](<../1-method/framework.md#§3 Architecture — mechanical-first>)) defines the v0→v3 stages; this document specifies WHAT each stage runs.
...
For Hebrew, see [`binding-rules-hebrew.md`](../1-method/binding-rules-hebrew.md) for the 14 validated rules (B1-B14, with B4 retired).
...
- [`framework.md`](../1-method/framework.md) — methodology specification
- [`binding-rules-hebrew.md`](../1-method/binding-rules-hebrew.md) — the 14 Hebrew binding rules
- [`apparatus.md`](apparatus.md) — scope statement
- [`methodology-position.md`](../4-process/methodology-position.md) — LDHB relationship

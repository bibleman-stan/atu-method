...
**Home:** `_old/framework.md:13-23` (i.e. `_old/framework.md`)
> ## §0.1 Mission
>
...
**Live-successor:** `1-method/framework.md §1 Purpose` (lines 9-19)
> ## §1 Purpose
>
...
**Live-successor:** null — verified by grep across live `1-method/framework.md` for `pragmatic stance` / `cognitive theory` returning no matches in live file. `methodology-position.md` exists adjacent but does not state the cognitive-theory disclaimer at any matched line (no §0.3 token).
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/R23.md:61` — same shape as R20: cites `§1`, not `§0.4`. Post-repoint state; the canon-index annotation "(repointed in Batch A1 to §1)" is faithful. No live `§0.4` token on disk in any consumer.

## §7.0 Categories A / B / C

**Home:** `1-method/framework.md:237-256` (live)
> ### §7.0 Categories A / B / C
>
...
**Consumers (verified):**
- `1-method/framework.md:237`: `### §7.0 Categories A / B / C` (definition)
- `1-method/framework.md:346`: `3. If clean ≥80% → apply clean decisions mechanically (Category A per §7.0), remove "proposed" label; capture the adoption evidence (sweep counts, audit verdicts) in the commit message.`
- `1-method/cross-corpus-principles.md:55`: `- Categories A/B/C: `framework.md §7.0``
- `2-evidence/scholarship/bofm/EP-1.md:153`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §2.1 (punctuation has zero force) + §7.0 (Category B editorial-judgment) + §1.5 J5 (substantive adjunct as own focus — interaction)`
...
**Home:** `1-method/framework.md:257-260` (live)
> ### §7.1 Authority
>
...
**Consumers (verified):**
- `1-method/framework.md:257`: `### §7.1 Authority` (definition)
- `_old/_index.md:24`: `- [`change-protocol.md`](change-protocol.md) — **Canon-change discipline.** §7.1 framework authority. §7.2 proposal requirements. §7.3 12 mandatory-audit triggers. ...` (archived index cite)
- `_old/change-protocol.md:10`: `## §7.1 Authority` (archived home)
- `_old/framework.md:367`: `The change protocol (§7.1 Authority through §7.8 Proposed-rule adoption protocol) has been extracted to its own canonical document: ...` (archived reference)
- `canon-index.md:123`: row entry self-citing `framework.md:257-260`.

**Consumers (FLAGGED):**
- Canon-index row reports "(no rot-list cites; structural-anchor only)" — consistent with absence of live consumer §7.1 citations in `2-evidence/scholarship/` / `memories/` / per-corpus canon files. Live structural-anchor with no operational consumers. Not a defect.

## §7.2 Proposal requirements

**Home:** `1-method/framework.md:261-277` (live)
> ### §7.2 Proposal requirements
>
...
**Consumers (verified):**
- `1-method/framework.md:261`: `### §7.2 Proposal requirements` (definition)
- `1-method/framework.md:333`: `- All three defensibility elements (WHY / HOW WE KNOW / SCOPE per §7.2) are captured for each addition (in the scholarship companion, not the canon).`
- `2-evidence/scholarship/bofm/R20.md:33`: `The BoFM-archaic register preserves KJV-style discourse-connective usage (*Wherefore*, *And now*, *Therefore*, *Yea*, *Behold*) as standalone-line beats. The closed list in the operational entry is corpus-attested and conservative — adding a connective requires worked corpus evidence per §7.2.`
- `_old/_index.md:24`: archived index cite (same line as §7.1 above).
- `_old/change-protocol.md:14`: `## §7.2 Proposal requirements` (archived home).
- `_old/change-protocol.md:86`: `- All three defensibility elements (WHY / HOW WE KNOW / SCOPE per §7.2) are captured ...` (archived self-ref).
- `_old/framework.md:367`: same archived reference cited under §7.1.
- `canon-index.md:124`: row entry.

**Consumers (FLAGGED):**
- Canon-index says "2-evidence/scholarship/bofm/R20.md:33 + 1 other rot-list cite" — the "1 other" is unnamed. Live grep finds only R20.md:33 across `atu-method/`. Possible second cite was the `change-protocol.md` archived self-ref (now `_old/`) and dropped from rot-list as Stage 1 resolved it. Flag for canon-index author confirmation.

## §7.3 Mandatory-audit triggers

**Home:** `1-method/framework.md:278-298` (live)
...
*atu-method/docs:*
- `1-method/framework.md:267`: `3. **Survive adversarial audit** (when any mandatory-audit trigger fires; see §7.3).`
- `1-method/framework.md:278`: `### §7.3 Mandatory-audit triggers (12 categories)` (definition)
- `1-method/framework.md:312`: `- `Audit-skippable per §7.3 ([reason])` with the reason citing one of §7.4 categories; OR`
- `1-method/cross-corpus-principles.md:130`: `§7.3`. A proposed sixth justification MUST demonstrate (a) that it is a genuinely distinct instance`
- `1-method/cross-corpus-principles.md:238`: `§7.3`.`
- `1-method/glossary.md:44`: `... Adding a marker is a §7.3 closed-list-extension audit trigger. See `framework.md §2.2`.`
- `3-implementation/substrate.md:23`: `... were all reshaped/killed at the §7.3 audit gate *before* code).`
- `2-evidence/deployment-status.md:21`: (line omitted by truncation)

*atu-method/scholarship:*
- `2-evidence/scholarship/_index.md:60`: `- `methodology/audit-discipline.md` — the WHY behind §7.3 mandatory-audit triggers.`
- `2-evidence/scholarship/methodology/_index.md:19`: `- `audit-discipline.md` — WHY the §7.3 mandatory-audit triggers. ...`
- `2-evidence/scholarship/methodology/_index.md:23`: `... (§7.3 trigger #1 if a new methodology essay is added; lower triggers for edits within existing essays).`
- `2-evidence/scholarship/bofm/R28.md:63`: `Both refinements were post-codification audit findings (§7.3 trigger #6 — mechanical-signature changes under a settled rule) ...`
- `2-evidence/scholarship/bofm/R28.md:107`: `... Both were §7.3 trigger #6 changes (mechanical-signature changes under a settled rule). ...`
- `2-evidence/scholarship/bofm/R15.md:44`: `... triggered the corpus-wide vocative sweep under §7.3 trigger #12-b ...`
- `2-evidence/scholarship/bofm/R15.md:97`: `... corpus-wide vocative sweep that followed (under §7.3 trigger #12-b post-detection) ...`
- `2-evidence/scholarship/bofm/R21.md:93`: `Per §Action-Codes "new action codes require a meta-template change (§7.3 trigger #9)," ...`
- `2-evidence/scholarship/bofm/R21.md:105`: `... awaits the validator's first corpus sweep (§7.3 trigger #12-a — post-codification goal-fit audit).`
- `2-evidence/scholarship/bofm/R20.md:93`: `... New exemptions would require §7.3 trigger #1 mandatory-audit dispatch with worked corpus example. ...`
- `2-evidence/scholarship/bofm/R20.md:117`: `... Pending corpus-attestation audit and §7.3 trigger #1 mandatory-audit dispatch.`
- `2-evidence/scholarship/bofm/EP-5.md:52`: `... Pending tasks for EP-5 corpus-fit work are tracked in BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/EP-5.md:128`: `... Per BoFM canon §7.3 trigger #12 (post-codification corpus-fit verification) ...`
- `2-evidence/scholarship/bofm/EP-4.md:75`: `... Per BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/EP-4.md:127`: `... Per BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/EP-1.md:61`: `... Pending tasks for EP-1 corpus-fit work are tracked in BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/EP-1.md:115`: `... Per BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/EP-3.md:58`: `... Pending tasks for EP-3 corpus-fit work are tracked in BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/EP-3.md:135`: `... Per BoFM canon §7.3 trigger #12 ...`
- `2-evidence/scholarship/bofm/R18a.md:81`: `... Building a rule on a singleton fails canon §7.3's biased-spot-check guard.`
- `2-evidence/scholarship/bofm/R6.md:129`: (line omitted by truncation)
...
- `_old/_index.md:24,42`; `_old/change-protocol.md:31,65`; `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:32,66`, `editorial-review-protocol.md:144`; `_old/toolset-architecture.md:27,30,157,190,196,208,229`; `_old/architecture.md:48,124`; `_old/rule-template.md:204`; `_old/2026-05-18-mechanical-first-rewrite/rule-template.md:111` — all archived; tombstoned with the `_old/` move.
...
- `2-evidence/deployment-status.md:21` matched in Grep but content omitted by truncation flag. Verifier could not paste verbatim line. Re-read needed to confirm §7.3 usage. Flagged.
- `2-evidence/scholarship/bofm/R6.md:129` matched in Grep but content omitted by truncation flag. Same — re-read needed.
- `project_bofm_substrate_quality.md:10` truncated, same flag.
- `1-method/framework.md:114` matched in Grep but content was omitted by `[Omitted long matching line]`. This is the §2.2:114 line area, possibly a §7.3 footnote/cross-ref. Re-read needed to confirm.
...
**Home:** `1-method/framework.md:299-307` (live)
> ### §7.4 Audit-skippable categories
>
...
**Consumers (verified):**
- `1-method/framework.md:299`: `### §7.4 Audit-skippable categories` (definition)
- `1-method/framework.md:312`: `- `Audit-skippable per §7.3 ([reason])` with the reason citing one of §7.4 categories; OR`
- `4-process/retraction-log-protocol.md:56`: `- Logging a retraction is itself audit-skippable per `change-protocol.md` §7.4 (defensibility-capture; the retraction event was prior).`
...
- `_old/_index.md:42`: `... A pure-navigation index update (this file) is audit-skippable per §7.4.` (archived)
- `_old/change-protocol.md:52`: `## §7.4 Audit-skippable categories` (archived home)
- `_old/change-protocol.md:65`: `- `Audit-skippable per §7.3 ([reason])` with the reason citing one of §7.4 categories; OR` (archived)
- `_old/retraction-log-protocol.md:63`: `... audit-skippable Category A operation (per `change-protocol.md` §7.4) ...` (archived)
- `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:53,66`: archived.
...
**Home:** `1-method/framework.md:308-316` (live)
> ### §7.5 Audit-evidence in commit messages
>
...
**Consumers (verified):**
- `1-method/framework.md:308`: `### §7.5 Audit-evidence in commit messages` (definition)
...
- `_old/change-protocol.md:61`: `## §7.5 Audit-evidence in commit messages` (archived)
- `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:62`: archived.
...
**Home:** `1-method/framework.md:317-326` (live)
> ### §7.6 Self-test before commit
>
...
**Consumers (verified):**
- `1-method/framework.md:317`: `### §7.6 Self-test before commit` (definition)
- `canon-index.md:128`: row entry.
- `_old/_index.md:24`: archived index cite (includes "§7.6 self-test before commit").
- `_old/change-protocol.md:70`: `## §7.6 Self-test before commit` (archived).
- `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:71`: archived.
...
**Consumers (FLAGGED):**
- Canon-index says "(no direct rot-list cites; structural-anchor; consumed by §7.5 commit-message construction)". Confirmed — no live §7.6 cites in `2-evidence/scholarship/`, `memories/`, or reader CLAUDE.mds outside the archived `_old/` paths. Faithful.

## §7.7 Self-consistency audit trigger

**Home:** `1-method/framework.md:327-336` (live)
> ### §7.7 Self-consistency audit trigger
>
...
**Consumers (verified):**
- `1-method/framework.md:327`: `### §7.7 Self-consistency audit trigger` (definition)
...
- `_old/_index.md:24`: archived index cite.
- `_old/change-protocol.md:80`: `## §7.7 Self-consistency audit trigger` (archived).
- `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:82`: archived.

**Consumers (FLAGGED):**
- The `feedback_compaction_resume_protocol.md:54` cite is an **example string inside a self-report illustration** — it is not a regulative cite of §7.7 ("apply this trigger") but a pretend-quote of past recovery prose mentioning §7.7. The canon-index "(1 cite)" is technically correct on token count but semantically thin. The row faithfully describes this as the sole cite; flagged for completeness — there is no operational consumer of §7.7 in live 2-evidence/scholarship/memories.

## §7.8 Proposed-rule adoption protocol

**Home:** `1-method/framework.md:337-351` (live)
> ### §7.8 Proposed-rule adoption protocol
>
...
**Consumers (verified):**
- `1-method/framework.md:337`: `### §7.8 Proposed-rule adoption protocol` (definition)
- `2-evidence/scholarship/bofm/R28.md:53`: `Adoption per §7.8: 27/28 clean (96.4%) — well above the 80% adoption threshold. ...`
- `2-evidence/scholarship/bofm/R28.md:87`: `R28 was proposed on 2026-04-19 and adopted to Active status on 2026-05-10 via a 27-instance corpus sweep (§7.8). ...`
- `2-evidence/scholarship/bofm/R28.md:115`: `... Adoption per §7.8 cleared the 80% threshold (96.4% clean). Status moved from Proposed to Active.`
- `2-evidence/scholarship/bofm/R28.md:151`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.4 J3 (speech-act announcement structural justification), §1.7 (decision procedure), §7.8 (proposed-rule adoption protocol)`
- `2-evidence/scholarship/bofm/R27.md:49`: `The 71/29 distribution at codification time was not yet a clean adoption signal per framework §7.8 (≥80% clean categorization required). ...`
- `2-evidence/scholarship/bofm/R27.md:105`: `... The rule was codified as **proposed** pending corpus-wide sweep verification (framework §7.8 — adoption requires ≥80% clean categorization).`
- `2-evidence/scholarship/bofm/R27.md:135`: `... but the formal status-promotion (proposed → active) per §7.8 awaits documented ≥80% clean-categorization evidence in the commit record.`
- `2-evidence/scholarship/bofm/R27.md:139`: `### Adoption per framework §7.8`
- `2-evidence/scholarship/bofm/R27.md:141`: `The rule remains **proposed**. Framework §7.8 requires the first corpus sweep to produce ≥80% clean categorization ...`
- `2-evidence/scholarship/bofm/R27.md:172`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.1 (generative principle), §1.3 (camera-angle test), §1.4 (J1, J5), §7.8 (proposed-rule adoption protocol); ...`
- `memories/feedback_three_anti_default_factors.md:25`: `Source: `change-protocol.md` §7.3 trigger #3 (spot-check-based proposals) + §7.8 (≥80% adoption threshold).`
...
- `_old/_index.md:24`: archived index cite.
- `_old/change-protocol.md:90`: `## §7.8 Proposed-rule adoption protocol` (archived).
- `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:92`: `## §7.8 Proposed-constraint adoption protocol` (archived; semantic drift "rule"→"constraint" but same anchor).
- `_old/framework.md:367`: archived reference.
...
**Home:** `1-method/framework.md:352-362` (live)
...
**Consumers (verified):**
- `1-method/framework.md:352`: `### §7.9 Binding-rule design checklist (per-rule additions)` (definition)
...
- `_old/2026-05-18-mechanical-first-rewrite/change-protocol.md:110`: `## §7.9 Architecture-method alignment check` (archived — DIFFERENT semantic content; archived §7.9 was an "architecture-method alignment check", live §7.9 is "binding-rule design checklist"). Same anchor ID, repurposed body in Stage 1.
- `_old/2026-05-18-mechanical-first-rewrite/canon-validator-alignment-protocol.md:49`: `- **Producer-vs-constraint framing.** ... covered by the periodic architecture-method alignment check (`change-protocol.md` §7.9).` (archived; cites the OLD §7.9 semantics, not the live one).
...
- Part C-bis (§7.x): 10 rows verified. All live in `1-method/framework.md:237-362`. Cite density audit:
...
8. `2-evidence/deployment-status.md:21`, `2-evidence/scholarship/bofm/R6.md:129`, `project_bofm_substrate_quality.md:10`, `1-method/framework.md:114` matched §7.3 grep but content was elided by the truncation flag — these lines are §7.3 hits but verifier could not paste verbatim from this verification cycle.
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/R27.md:105`: §1.1 token not present at line 105. Full-file grep for `§1.1` in R27.md returns only line 172. The canon-index citation `R27.md:105` is wrong for §1.1.
- `2-evidence/scholarship/bofm/R21.md:21`: Canon-index cites `R21.md:21`. Actual §1.1 hit is line 21 (verified — the "is therefore not a Structural Justification" line). Confirmed correct.
- `2-evidence/scholarship/bofm/R5.md:147`: Canon-index lists `R5.md:147` under §1.1 consumers. Line 147 reads: `- Universal framework: [...] §1.5 (merge-overrides — R5 is structurally parallel to M1 on the *or* coordinator), §1.9 (N=2 Adjudication Principle), §2 (Categories A/B/C — R5 is principled Category B)`. §1.1 token NOT present. Cite is wrong; R5.md contains no §1.1 reference (full-file grep returned no matches).

---

## §1.2 Syntax forbids splits (umbrella)

**Home:** `_old/framework.md:67-81`
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R12.md:149`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2 (syntax forbids splits), §1.5 M1 (Gorgianic bonded pair / verb-synonymy test), §1.9 (N=2 Adjudication Principle)`
- `2-evidence/scholarship/bofm/R10.md:132`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2 (syntax forbids splits — Layer 1 mid-phrase prohibitions), §1.4 J1 (compound-list-break-signals sub-rule — governs coordinate-object exclusion), §1.5 M1 (asymmetric-modifier sub-clause — governs Mosiah 18:7 third-item modifier), §1.9 (N=2 Adjudication / N=3+ cliff scope to predications, not objects)`
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/R5.md:147`: Canon-index lists `R5.md:147` under §1.2 consumers ("syntax forbids splits"). Verified line 147: `§1.5 (merge-overrides...), §1.9 (N=2 Adjudication Principle), §2 (Categories A/B/C ...)`. §1.2 token NOT present. Full-file grep for `§1.2` in R5.md returns no matches. Cite is wrong.
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R13a.md:49`: `- Universal framework: `atu-method/1-method/framework.md §1.2.1` (Layer 1 mid-phrase prohibitions)`
- `2-evidence/scholarship/bofm/R11.md:47`: `- Universal framework: `atu-method/1-method/framework.md §1.2.1` (Layer 1 mid-phrase prohibitions)`
- `2-evidence/scholarship/bofm/R16.md:112`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2.1 (Layer 1 mid-phrase prohibitions; line-final subordinator dangles forward), §1.2.3 (formula integrity)`
- `2-evidence/scholarship/bofm/R10.md:17`: `This is not preference. The object is an **obligatory argument** of the transitive verb's syntactic frame. Without the object NP, the transitive verb is not predicating anything complete. The framework treats this case under §1.2.1 (Layer 1 mid-phrase prohibitions): syntax does not generate breaks but vetoes them, and the verb-object bond is the canonical case where the veto fires absolutely.`
- `2-evidence/scholarship/bofm/R15.md:136`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2.1 (Layer 1 mid-phrase prohibitions — vocative integrity), §1.9 (N=2 Adjudication does NOT apply to appositional constructions including vocative+close-appositive)`
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R17.md:19`: `The apparatus's atomic-thought test, applied at the matrix-clause level, therefore mandates merge when the complement and matrix are on different lines. The rule is one of the framework's "syntax forbids splits" cases (`framework.md §1.2.2`): the matrix's valence is unsatisfied without its clausal complement, and a split that fragments the matrix from its complement violates the syntactic floor.`
- `2-evidence/scholarship/bofm/R26.md:165`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2.2 (syntax forbids splits — complement integrity), §1.5 M2 (verb-object clause-nucleus bond, alias of complement-integrity); BoFM canon §3.5 Tier 3 (Complement integrity), §3.5.1 (the *that*-cluster sub-hierarchy)`
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R1.md:69`: `The sibling GNT canon's rule on *καὶ ἐγένετο* formula integrity, and Tanakh's rule on wayyiqtol narrative formulas, are sister instantiations of the same universal formula-integrity principle (see `framework.md §1.2.3`). Each per-corpus canon enumerates its own formula inventory because formulas are language-specific lexical bundles; the universal principle is consistent across canons.`
- `2-evidence/scholarship/bofm/R1.md:106`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2.3 (formula integrity)`
...
**Live-successor:** null — verified by Grep across `1-method/framework.md` for `J1|J5|camera|1\.3|1\.4` returning zero hits. Live framework.md uses a new structure (§1 Purpose / §2 The criterion w/ §2.1 bidirectional + §2.2 explicit-marker) with NO J1-J5 or camera-angle content.

**Consumers (verified):**
- `2-evidence/scholarship/bofm/R27.md:105`: `Three-condition merge test (word count ≤8, subject continuity, no camera-angle shift), with the default direction SPLIT. The rule was codified as **proposed** pending corpus-wide sweep verification (framework §7.8 — adoption requires ≥80% clean categorization).`
- `2-evidence/scholarship/bofm/R27.md:172`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.1 (generative principle), §1.3 (camera-angle test), §1.4 (J1, J5), §7.8 (proposed-rule adoption protocol); BoFM canon §3.5 Tier 5 (R7 yields-to R27), §3.5.1 (*that*-cluster precedence)`
- `2-evidence/scholarship/gnt/R25.md:131`: `The 3-condition merge test itself, the word-count threshold (≤8), the subject-continuity condition, and the camera-angle condition were all verified adversarially against Phase A candidates before application. No additional carve-outs or threshold adjustments were required by the audit.`
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/R28.md (multiple)`: NO matches for `camera-angle` OR `§1.3` in R28.md. Closest is `R28.md:21` and `:151` which cite §1.4 J3, NOT §1.3 camera-angle. The audit row's claim that R28.md is a §1.3 consumer fails ground-truth — R28.md cites §1.4 J3 only.

---

## §1.3a rhetoric figures constrain

**Home:** _old/framework.md:89-104
...
**Live-successor:** null — Grep across `1-method/framework.md` returned zero hits for rhetoric/figures content; live framework restructure has no §1.3a successor.
...
**Home:** _old/framework.md:106-164
...
**Live-successor:** null — no J1-J5 / §1.4 token in live `1-method/framework.md`.
...
- `readers-bofm/1-method/colometry-canon.md:2653`: `**Framework anchor:** Corpus-specific operational instantiation of framework M4 (fragmented atomic thought-unit; see [`atu-method/1-method/framework.md §1.5`](1-method/framework.md)).` — NOTE: cites §1.5 M4, NOT §1.4. Mis-attributed in audit row.
...
**Home:** _old/framework.md:112-126
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R10.md:132`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2 (syntax forbids splits — Layer 1 mid-phrase prohibitions), §1.4 J1 (compound-list-break-signals sub-rule — governs coordinate-object exclusion), §1.5 M1 (asymmetric-modifier sub-clause — governs Mosiah 18:7 third-item modifier), §1.9 (N=2 Adjudication / N=3+ cliff scope to predications, not objects)`
- `2-evidence/scholarship/bofm/EP-5.md:174`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.4 J1 (formally-marked parallel series — the parallel-stacking interaction) + §1.9 N=2 Adjudication Principle and N=3+ cliff + §2 (Category B editorial-judgment)`
- `readers-bofm/1-method/colometry-canon.md:487`: `4. *Or*-coordinations functioning as compound objects under a shared verb or preposition (J1 compound-list members) → §1.4 J1 governs the head-and-object analysis; if the compound list reads as J1 series, R5 yields. The N=3+ cliff (§1.9) does not engage R5 because R5 fires only on N=2 *or*-pairs.`
...
- `2-evidence/scholarship/bofm/R20.md:126`: (same line cited under §1.4 umbrella above) — verified.
...
**Home:** _old/framework.md:116-123
> 116: `**Compound list break signals.** In a compound list governed by one preposition or verb, bare coordinate items (e.g., *"and [noun]"*) are compound objects and stay merged. A break inside a compound list is justified only when one of these signals is present:`
...
- `2-evidence/scholarship/bofm/R10.md:132`: cited verbatim above — `§1.4 J1 (compound-list-break-signals sub-rule — governs coordinate-object exclusion)`.
...
**Home:** _old/framework.md:127-129
...
**Home:** _old/framework.md:131-135
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/EP-3.md (J3-routes)`: Grep for `J3` / `J1` / `J5` / `speech-act` / `route` (case-insensitive) returns ZERO `J3` matches in EP-3.md. The only J-token hits are J1 (lines 51, 70, 72, 74, 127, 178). The audit row's claim of EP-3.md as a J3-routes consumer fails ground-truth.

---

## J4 — Classical commata

**Home:** _old/framework.md:137-139
...
**Home:** _old/framework.md:141-164
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/EP-1.md:153`: cites `§1.5 J5` (line 153 verbatim: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §2.1 (punctuation has zero force) + §7.0 (Category B editorial-judgment) + §1.5 J5 (substantive adjunct as own focus — interaction)`). The audit row already flags this as MALFORMED — confirmed: J5 is in §1.4 of the home (line 141), not §1.5. EP-1.md cite mis-numbered.
- `2-evidence/scholarship/bofm/R26.md`: NO match for `§1.4` OR `J5` (case-sensitive) in R26.md. R26.md cites only `§1.2.2`, `§1.5 M2`, and BoFM canon §3.5 Tier 3 / §3.5.1. The audit row's claim of R26.md as a J5 consumer fails ground-truth — R26 is complement-integrity / M2 territory, not J5.

---

## J5 sub-clauses: degree-quantifier exclusion + same-slot diagnostic

**Home:** _old/framework.md:148-152
...
8. **Live successor across all rows:** confirmed null — live `1-method/framework.md` Greps for `J1|J5|camera|1\.3|1\.4` return ZERO hits. Live framework restructured to §1 Purpose / §2 The criterion (§2.1 bidirectional + §2.2 explicit-marker); J1-J5 / camera-angle / §1.3 / §1.4 anchors do not survive into the live canon.
...
**Home:** _old/framework.md:166-244 (actual path: `_old/framework.md:166-244`)
...
**Live-successor:** null — no live successor (verified by Grep across live `1-method/framework.md`: `§1\.5|§1\.6|§1\.7|§1\.8|Four Merge-Override|Decision procedure|Application order|four forces` → No matches found). The live `framework.md` has been rewritten without numbered §1.x sections that match these anchors.

**Consumers (verified):**
- `2-evidence/scholarship/bofm/R10.md:132`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2 (syntax forbids splits — Layer 1 mid-phrase prohibitions), §1.4 J1 (compound-list-break-signals sub-rule — governs coordinate-object exclusion), §1.5 M1 (asymmetric-modifier sub-clause — governs Mosiah 18:7 third-item modifier), §1.9 (N=2 Adjudication / N=3+ cliff scope to predications, not objects)`
- `2-evidence/scholarship/bofm/R5.md:147`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.5 (merge-overrides — R5 is structurally parallel to M1 on the *or* coordinator), §1.9 (N=2 Adjudication Principle), §2 (Categories A/B/C — R5 is principled Category B)`
- `2-evidence/scholarship/bofm/EP-1.md:153`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §2.1 (punctuation has zero force) + §7.0 (Category B editorial-judgment) + §1.5 J5 (substantive adjunct as own focus — interaction)` — **NOTE: cites "§1.5 J5" but J5 is in §1.4, not §1.5** (likely a typo / cross-section reference)
- `2-evidence/scholarship/bofm/R12.md:149`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2 (syntax forbids splits), §1.5 M1 (Gorgianic bonded pair / verb-synonymy test), §1.9 (N=2 Adjudication Principle)`
- `2-evidence/scholarship/bofm/R20.md:126`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1 (atomic-thought mission), §1.1 (generative principle — each proposition splits by default), §1.4 J1-J5 (the five structural justifications — referenced by Exemption 4), §1.5 M3 (bare-governor indivisibility — related "fragment fails atomic-thought" failure mode)`
- BoFM canon:34 pointer block: `readers-bofm/1-method/colometry-canon.md:34` → `**Pointer to framework.** The framework specification — generative principle...; four merge-overrides M1–M4 (Gorgianic bonded pair, verb-object clause-nucleus bond, bare-governor indivisibility, fragmented atomic thought-unit)...is codified at [`atu-method/1-method/framework.md §1`](1-method/framework.md). This canon does not duplicate that prose.`
- GNT canon:48 pointer block: `readers-gnt/private/01-method/colometry-canon.md:48` → `**Pointer to framework.** The framework specification...four merge-overrides M1–M4...is codified at [`atu-method/1-method/framework.md §1`](1-method/framework.md). This canon does not duplicate that prose.`
...
**Consumers (FLAGGED):**
- `2-evidence/scholarship/bofm/EP-1.md:153` cites "§1.5 J5" — but J5 is part of §1.4 (five structural justifications), not §1.5 (four merge-overrides). Section number mismatch.

---

## M1 — Gorgianic bonded pair

**Home:** _old/framework.md:176-203 (actual path: `_old/framework.md:176-203`)
> `### M1 — Gorgianic bonded pair`
...
**Live-successor:** null — no live successor in `1-method/framework.md` (verified via Grep `M1|M2|M3|M4|merge-override` — only 2 hits, both meta-references about "merge-overrides" as concept).

**Consumers (verified):**
- `2-evidence/scholarship/bofm/R12.md:149`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2 (syntax forbids splits), §1.5 M1 (Gorgianic bonded pair / verb-synonymy test), §1.9 (N=2 Adjudication Principle)`
- `2-evidence/scholarship/bofm/R5.md:147`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.5 (merge-overrides — R5 is structurally parallel to M1 on the *or* coordinator)...`
- `2-evidence/scholarship/bofm/EP-5.md:50`: `- **N=2 virtue pairs** — *faith and hope*, *meek and lowly*, *chastity and virtue*, *faith and patience*. ~20-30 instances corpus-wide. N=2 routes to §1.9 N=2 Adjudication Principle (M1 synonymy test) before reaching EP-5; most resolve to M1 merge as cognate / bonded pairs.`
- `2-evidence/scholarship/bofm/EP-5.md:108`: `- **Risk: the rule could over-fire on N=2 cognate pairs.** Resolution: explicit interaction with §1.9 N=2 Adjudication Principle — N=2 pairs route to M1 synonymy test before EP-5 is consulted; EP-5 fires only on N≥3 stacks or on N=2 cases that M1 leaves unresolved.`
- `2-evidence/scholarship/bofm/R22.md:168`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.5 M1 (appositional constructions explicitly outside M1's N=2 scope), §1.9 (N=2 Adjudication Principle explicitly excludes appositives)`
- BoFM canon:38-39: `readers-bofm/1-method/colometry-canon.md:38` → `- **M1 bonded-pair list (verb pairs, corpus-attested):** ...M1 verb-pair protection fires only on N=2 verb-coordination per the N=2-only caveat in atu-method/1-method/framework.md §1.5. Detector reference: ...` and line 39 → `- **M1 nominal-pair canonical cases:** *grace and mercy*, *heaven and earth*, *dust and ashes*, ...`
...
**Home:** _old/framework.md:201 (actual: `_old/framework.md:201`)
...
- Additional consumer found: `2-evidence/scholarship/bofm/R10.md:56`: `- M1 asymmetric-modifier sub-clause (framework §1.5) treats the trailing PP *on the Lord* as semantically attaching to the joint object-set; the third item remains bonded with its co-objects.`
...
**Home:** _old/framework.md:205-209 (actual: `_old/framework.md:205-209`)
> `### M2 — Verb-object clause-nucleus bond`
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R10.md` multiple §1.5 hits — but the M2 reference there is structural-citation only (line 132 just says §1.5 M1, no M2). Grepping for "M2" in R10.md:
- `2-evidence/scholarship/bofm/R26.md:165`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.2.2 (syntax forbids splits — complement integrity), §1.5 M2 (verb-object clause-nucleus bond, alias of complement-integrity); BoFM canon §3.5 Tier 3 (Complement integrity), §3.5.1 (the *that*-cluster sub-hierarchy)`
...
**Home:** _old/framework.md:211-230 (actual: `_old/framework.md:211-230`)
> `### M3 — Bare-governor indivisibility`
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/R19.md:134`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.1 (generative principle — cataphoric splits), §1.5 M3 (bare-governor indivisibility — anaphoric merges), §2.1 (punctuation has zero force — motivates UPOS-gated proxy)`
...
**Home:** _old/framework.md:232-244 (actual: `_old/framework.md:232-244`)
> `### M4 — Fragmented atomic thought-unit`
...
**Consumers (verified):**
- `2-evidence/scholarship/bofm/M4-BoFM-1.md:146`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.5 M4 (fragmented atomic thought-unit)`
- `2-evidence/scholarship/gnt/M4-GNT-1.md:190`: `- Universal framework: [`../../1-method/framework.md`](1-method/framework.md) §1.5 M4 (fragmented atomic thought-unit)`
...
**Home:** _old/framework.md:246-254 (actual: `_old/framework.md:246-254`)
...
**Consumers (verified):**
- BoFM canon:34 pointer block: `readers-bofm/1-method/colometry-canon.md:34` → `...the four forces summary; the five-step decision procedure; the application-order step-by-step...is codified at [`atu-method/1-method/framework.md §1`](1-method/framework.md). This canon does not duplicate that prose.`
- GNT canon:48 pointer block: `readers-gnt/private/01-method/colometry-canon.md:48` → `...the four forces summary; the five-step decision procedure; the application-order step-by-step...is codified at [`atu-method/1-method/framework.md §1`](1-method/framework.md). This canon does not duplicate that prose.`
...
**Home:** _old/framework.md:256-266 (actual: `_old/framework.md:256-266`)
> `## §1.7 Decision procedure`
...
**Home:** _old/framework.md:268-280 (actual: `_old/framework.md:268-280`)
...
**Home:** `atu-method/_old/framework.md:282-297`
> `## §1.9 N=2 Adjudication Principle`
...
**Live-successor:** null — `Grep "§1\.9\b"` over live `atu-method/1-method/framework.md` returned no matches; live framework.md sections are §1-§7 architecture (no §1.x sub-numbering below §1). However the SUBSTANCE is hosted at `atu-method/1-method/cross-corpus-principles.md §1.9` per its §0.2 manifest ("This document HOSTS: ... §1.9 (N=2 adjudication + N=3+ cliff)").
...
**Consumers (verified):**
- `atu-method/2-evidence/scholarship/bofm/EP-5.md:50`: `- **N=2 virtue pairs** — *faith and hope*, *meek and lowly*, *chastity and virtue*, *faith and patience*. ~20-30 instances corpus-wide. N=2 routes to §1.9 N=2 Adjudication Principle (M1 synonymy test) before reaching EP-5; most resolve to M1 merge as cognate / bonded pairs.`
- `atu-method/2-evidence/scholarship/bofm/EP-5.md:108`: `- **Risk: the rule could over-fire on N=2 cognate pairs.** Resolution: explicit interaction with §1.9 N=2 Adjudication Principle — N=2 pairs route to M1 synonymy test before EP-5 is consulted; EP-5 fires only on N≥3 stacks or on N=2 cases that M1 leaves unresolved.`
- `atu-method/2-evidence/scholarship/bofm/EP-5.md:174`: `- Universal framework: ... §1.4 J1 ... + §1.9 N=2 Adjudication Principle and N=3+ cliff + §2 (Category B editorial-judgment)`
- `atu-method/2-evidence/scholarship/bofm/R10.md:60`: `This case demonstrates R10's interaction with framework §1.9's N=3+ cliff: the cliff is scoped to coordinate **predications** ..., NOT to coordinate **objects** under a single shared verb.`
- `atu-method/2-evidence/scholarship/bofm/R10.md:132`: `- Universal framework: ... §1.9 (N=2 Adjudication / N=3+ cliff scope to predications, not objects)`
- `atu-method/2-evidence/scholarship/bofm/R12.md:106`: `Resolution: incorporate the §1.9 N=2 Adjudication Principle as a sub-rule, with M1 verb-synonymy as the diagnostic.`
- `atu-method/2-evidence/scholarship/bofm/R12.md:111`: `the framework promoted the diagnostic to a named cross-cutting principle (§1.9). ... R12's N=2 sub-rule now references §1.9 directly`
- `atu-method/2-evidence/scholarship/bofm/R12.md:149`: `- Universal framework: ... §1.9 (N=2 Adjudication Principle)`
- `atu-method/2-evidence/scholarship/bofm/R15.md:136`: `- Universal framework: ... §1.9 (N=2 Adjudication does NOT apply to appositional constructions including vocative+close-appositive)`
- `atu-method/2-evidence/scholarship/bofm/R18a.md:56`: `default-merge per canon §1.9 (coordinate predications only earn N≥3 stacking).`
- `atu-method/2-evidence/scholarship/bofm/R18a.md:119`: `- Adjacent rule (coordinate-object scope): canon §1.9 (N≥3 cliff predication-only scope), R10 sub-rule 3, R5 sub-rule 4`
- `atu-method/2-evidence/scholarship/bofm/R22.md:108`: `The §1.9 N=2 Adjudication Principle (M1 synonymy test) was reviewed for applicability to divine-title appositives. Verdict: explicitly excluded.`
- `atu-method/2-evidence/scholarship/bofm/R22.md:110`: `The exclusion is recorded in §1.9 ("Does NOT apply to appositional constructions") and in BoFM canon §3.5 Tier 6`
- `atu-method/2-evidence/scholarship/bofm/R22.md:168`: `- Universal framework: ... §1.9 (N=2 Adjudication Principle explicitly excludes appositives)`
- `atu-method/2-evidence/scholarship/bofm/R5.md:136`: `The N=3+ cliff (§1.9) suggests that at N=3+ the structure would default to J1 series treatment`
- `atu-method/2-evidence/scholarship/bofm/R5.md:147`: `- Universal framework: ... §1.9 (N=2 Adjudication Principle), §2 (Categories A/B/C — R5 is principled Category B)`
...
- `Dropbox/gnt-reader-private/01-method/colometry-canon.md:183`: `**Pointer to framework.** The five structural justifications ... and the N=2 Adjudication Principle are codified at [`atu-method/1-method/framework.md §1.4–§1.9`]`
...
**Consumers (FLAGGED):**
- `atu-method/2-evidence/scholarship/bofm/R21.md`: audit row claims §1.9 consumer, `Grep "§1\.9" R21.md` returns NO matches. PHANTOM CITE.
- `atu-method/2-evidence/scholarship/bofm/R28.md`: audit row claims §1.9 consumer, `Grep "§1\.9" R28.md` returns NO matches. PHANTOM CITE.
- `atu-method/2-evidence/scholarship/bofm/R18.md`: audit row claims §1.9 consumer, `Grep "§1\.9" R18.md` returns NO matches. PHANTOM CITE.
- `atu-method/2-evidence/scholarship/bofm/M4-BoFM-1.md`: audit row claims §1.9 consumer, `Grep "§1\.9" M4-BoFM-1.md` returns NO matches. PHANTOM CITE.
- `atu-method/2-evidence/scholarship/gnt/R25.md`: audit row claims §1.9 consumer, `Grep "§1\.9" R25.md` returns NO matches. PHANTOM CITE.
- `atu-method/2-evidence/scholarship/gnt/R28-ext.md`: audit row claims §1.9 consumer, `Grep "§1\.9" R28-ext.md` returns NO matches. PHANTOM CITE.
- `atu-method/2-evidence/scholarship/gnt/M4-GNT-1.md`: audit row claims §1.9 consumer, `Grep "§1\.9" M4-GNT-1.md` returns NO matches. PHANTOM CITE.
...
- 60+ files claim from audit row is OVERSTATED. Actual ground-truthed consumers: 7 atu-method/2-evidence/scholarship/bofm files + 1 BoFM canon (Dropbox) + 1 GNT canon (Dropbox) + 1 BoFM validator + 1 Tanakh script = ~11 distinct files containing §1.9 citations (not "60+").

---

## §1.9 N=3+ cliff SCOPE sub-clause (predications-vs-objects)

**Home:** `atu-method/_old/framework.md:297`
...
**Consumers (verified):**
- `atu-method/2-evidence/scholarship/bofm/R10.md:60`: `This case demonstrates R10's interaction with framework §1.9's N=3+ cliff: the cliff is scoped to coordinate **predications** (compound verbs, coordinate *that*-clauses, coordinate finite clauses), NOT to coordinate **objects** under a single shared verb. Three coordinate objects under one verb do not invoke J1's win-over-merge mandate; they remain part of one predication.`
- `atu-method/2-evidence/scholarship/bofm/R18a.md:119`: `- Adjacent rule (coordinate-object scope): canon §1.9 (N≥3 cliff predication-only scope), R10 sub-rule 3, R5 sub-rule 4`
...
**Home:** `atu-method/_old/framework.md:299-309`
> `## §1.10 Punctuation is not a break signal`
> (followed by 11 lines elaborating "no deterministic role"; "Test."; "every punctuation mark from the source text stays in place")

**Live-successor:** SUBSTANCE migrated to `atu-method/1-method/framework.md §2.1` ("Punctuation has ZERO force"). Verified via consumer cites in R19/EP-1 below ("framework §2.1, 'Punctuation has ZERO force'"). No live `§1.10` section exists in live framework.md (`Grep "§1\.10"` over live framework.md returned no matches).
...
- `atu-method/2-evidence/scholarship/bofm/R19.md:31`: `The methodology forbids punctuation as a break signal (framework §2.1, "Punctuation has ZERO force"). The apparatus therefore needs an alternative proxy ...` — REPOINTED to §2.1 (no §1.10 token).
- `atu-method/2-evidence/scholarship/bofm/R19.md:134`: `- Universal framework: ... §2.1 (punctuation has zero force — motivates UPOS-gated proxy)` — REPOINTED to §2.1.
...
**Home:** `atu-method/_old/framework.md:311-313`
> `## §1.11 Versification is not a break signal`
...
**Live-successor:** SUBSTANCE migrated to `atu-method/1-method/framework.md §3` v1.6 cross-verse continuity per cross-corpus-principles.md:52: `- Versification-not-a-signal: \`framework.md §3\` v1.6 cross-verse continuity`. No live `§1.11` section exists in live framework.md (`Grep "§1\.11"` over live framework.md returned no matches).

**Consumers (verified):**
- `Dropbox/bom-reader-private/01-method/colometry-canon.md:34`: pointer block — `punctuation-not-a-signal and versification-not-a-signal stances ... is codified at [\`atu-method/1-method/framework.md §1\`]`
...
- `atu-method/_old/rule-equivalence-map.md:23`: `Cross-verse continuity (atomic thought spanning verse boundary stays intact) | R14 (implied ... handled by framework §1.11) | §3.17 cross-verse-continuity-merge | H10 (explicit rule ...)`
...
**Home:** `atu-method/_old/framework.md:313-323`
> `## §1.12 Parallel-List Uniformity Principle`
...
- `atu-method/_old/rule-equivalence-map.md:25`: `**Parallel-list uniformity** ... (framework §1.12 applies) ... | (Same framework §1.12 principle.)`
- `atu-method/2-evidence/scholarship/bofm/R6.md:140`: `- Universal framework: ... §1.12 (Parallel-List Uniformity); BoFM canon §3.5 Tier 5`
- `atu-method/2-evidence/scholarship/bofm/R7.md:138`: `- Universal framework: ... §1.12 (Parallel-List Uniformity); BoFM canon §3.5 Tier 5 (yields-to relationships)`

**Consumers (FLAGGED):**
- `atu-method/2-evidence/scholarship/bofm/R10.md`: audit row asserted R10 as §1.12 consumer; `Grep "§1\.12" R10.md` returns NO matches (R10's §1.12 row in audit is a PHANTOM CITE — R10 cites §1.9, §1.2, §1.4, §1.5, NOT §1.12).
...
**Home:** `atu-method/_old/framework.md:331-337`
> `## §1.13 Authorial asymmetry overrides editorial symmetry`
...
- `atu-method/2-evidence/scholarship/bofm/R28.md:132`: `Recommendation: rename the §1 Authorial Asymmetry Principle to a structural-principle ID (e.g., a §1.13 stable section ID without the R28 designation, since structural principles in §1 are not per-rule entries in §5).` — meta-reference (proposing rename, not asserting current §1.13 as live).
...
- `atu-method/2-evidence/scholarship/gnt/R28-ext.md`: audit claims §1.13 consumer; `Grep "§1\.13" R28-ext.md` returns NO matches. PHANTOM CITE for §1.13 specifically (R28-ext.md may discuss R28 substance but does not cite the §1.13 token).
- `atu-method/2-evidence/scholarship/bofm/R28.md`: only ONE §1.13 reference (line 132), and it's a META-PROPOSAL to rename — not a substantive consumer of §1.13's normative text.
...
**Receipts:** `Grep "framework\.md"` over `C:/Users/bibleman/repos` returns 77 files (see file list above). Confirmed as the universally-cited canonical doc. Live at `atu-method/1-method/framework.md` (Glob verified).
...
2. atu-method/1-method/cross-corpus-principles.md
3. atu-method/00-start-here.md
4. atu-method/1-method/binding-rules-lxx.md
5. atu-method/1-method/framework.md
6. atu-method/3-implementation/apparatus.md
7. atu-method/1-method/glossary.md
8. atu-method/4-process/methodology-position.md
...
13. atu-method/3-implementation/toolset-architecture.md

...
- End-of-major-task message includes a "Deferred to you" table or bullet list in **chat**, even if it's "(none)". The chat-window surface is the primary place for surfacing deferred items, per [[memories/feedback_decisions_in_chat_not_files.md|feedback_decisions_in_chat_not_files.md]] Section B (which explicitly prohibits depositing decisions in pending.md or other files).
...
- [[memories/feedback_decisions_in_chat_not_files.md|feedback_decisions_in_chat_not_files.md]] — decisions surface in chat, not in files. This memory respects that boundary: status-tracking in pending.md is acceptable, decision-deposit is not.
- [[memories/feedback_no_eyeball_offers.md|feedback_no_eyeball_offers.md]] — don't manufacture deferrals after audit clears a sweep.
- [[memories/feedback_no_fake_dilemmas.md|feedback_no_fake_dilemmas.md]] — don't route mechanically-resolved cases through "borderline / pending judgment" framings.

...
- Relates to the substantive-adjunct test (bidirectional test affirmation per [[1-method/framework.md|framework.md §1.2]]): a Hebrew-marked fronted constituent that introduces *new* topical content is cataphoric and can stand; a fronted constituent that is anaphoric to prior topic does not.

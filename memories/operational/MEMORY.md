...
- [feedback_scratch_belongs_in_repo.md](feedback_scratch_belongs_in_repo.md) — C:\tmp is DEPRECATED as scratch (grew to 1.2GB unmanaged); reusable dev 5-machinery/scripts → repo tracked 5-machinery/scripts//research/, true throwaway → repo gitignored scratch/ (or work\_scratch\); promote keepers immediately

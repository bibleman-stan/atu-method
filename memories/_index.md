...
- [`feedback_sense_line_mission.md`](feedback_sense_line_mission.md) — **DEMOTED 2026-08-06** (historical record; do not cite as the mission statement). Its ground — *rhetoric constrains, atomic-thought determines* — lives in [`../docs/01-normative/cross-corpus-principles.md`](../docs/01-normative/cross-corpus-principles.md) §0.1 + §1.3a and [`feedback_atu_and_rhetorical_lenses_distinct.md`](feedback_atu_and_rhetorical_lenses_distinct.md). Whether `framework.md` §1's NOT-list should still exclude the aural + rhetorical lenses is an open Category B question awaiting Stan's ruling.

...
`readers-bofm/scholarship/M4-BoFM-1.md` + BoFM canon §5; GNT M4-GNT-1 (Subject-Orphan Predicate
Completion) in `readers-gnt/scholarship/M4-GNT-1.md` + GNT canon §3.18.
...
[`../scholarship/`](../scholarship/). For methodology lessons + discipline memories, see
[`../memories/`](../memories/).*

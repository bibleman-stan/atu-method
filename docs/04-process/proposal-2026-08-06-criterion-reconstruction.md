...
Grepped 2026-08-06 across `framework.md`, `cross-corpus-principles.md`, `binding-rules-*.md`, `docs/_old/`, and the BoFM + GNT per-corpus canons:
...
- [`../01-normative/framework.md`](../01-normative/framework.md) §2.1, §2.2, §7.0, §7.3

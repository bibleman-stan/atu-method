...
`atu-method/docs/binding-rules-lxx.md`. This note preserves the *rationale* behind
...
note. Ideal long-term home is `atu-method/docs/framework.md` §ATU definition._

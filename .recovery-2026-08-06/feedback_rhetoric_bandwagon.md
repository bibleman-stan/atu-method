...
3. **Check for §0.3 violations.** `atu-method/docs/framework.md` §0.3 (Pragmatic stance) disclaims cognitive-theory grounding. Other LLMs sometimes re-introduce cognitive-theoretic claims through the back door (e.g., "mathematically isolating the boundaries of human thought formulation"). Catch these.

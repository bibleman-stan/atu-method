...
- [[2-evidence/finding-licensor-share.md|finding-licensor-share.md]] — claim #6 measured. The §2.2 marker license generates **345 of 29,762** BoFM lines (**1.16%**); the quarantine holds and §2.1 is load-bearing. Four of five corpora have no §2.2 registry at all, so §2.1 is currently the only licensor outside BoFM.

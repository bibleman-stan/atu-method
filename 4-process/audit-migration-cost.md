...
scripts/apply_specs.py:306:    runner = SpecRunner(args.specs)      # applies the rules
scripts/run_validators.py:31:  from validators._shared.spec_runner import SpecRunner   # checks the rules
```
...
readers-lxx     13 untracked scripts

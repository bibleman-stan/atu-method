...
- The pipeline reads BHSA / Macula / CoNLL-U parses and applies the binding rules of [`binding-rules-hebrew.md`](../1-method/binding-rules-hebrew.md). It does NOT read LDHB tags.
...
- Where the apparatus's output diverges from LDHB, the divergence is either:
  ...
  - **Architectural** — a known gap ([`framework.md` §6](<../1-method/framework.md#§6 Known gaps>)) that future v2 LLM adjudication or editorial review handles
